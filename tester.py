    ...
    def test(self):
        ...
        for i, (images, _, label, captions, prob) in enumerate(self.data_loader):
            ...
            for sentence_index in range(captions.shape[1]):
                print("%dth sentence_index" % sentence_index)
...
if __name__ == '__main__':
    ...
    # model_dir = '../../stary/medical_report/report_models/debugging/20180614-11:08'
    # model_dir = './report_models/training/20180618-04:11'
    ...
    parser.add_argument('--result_name', type=str, default='result_test',  #modify by pjl
